...
from gestion_etudiant.Etudiants.models import (Module, Groupe, Etudiant, 
...
def main():
    ...
    # 
        # list_module = prof_service.get_all()
    # # print("============================= Etudiants ==============================|")
